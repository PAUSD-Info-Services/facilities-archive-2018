...
Drupal.behaviors.simpletheme = {
  attach: function(context, settings) {
    ...
    $('body', context).once('st', function(){
      ...
      scrollButtons = '#front-scrolldown > a',
      faqQuestionSelector = '.field-name-field-pdf-faq-items > .field-items > .field-item',
      agendaItemSelector = '.field-name-field-pdm-meeting-subitem-title > .field-items',
      faqQuestionActiveClass = 'accordion-active';
      ...
      // toggle accordion questions
      $(faqQuestionSelector).find('.field-name-field-pdf-question').on('click', function(){
        // apply active class
        $(this).parents('.field-item').toggleClass(faqQuestionActiveClass);
      })
      
      // toggle agenda items
      $(agendaItemSelector).on('click', function(){
        // apply active class
        // special handling for meetings archive.
        if($('body').hasClass('page-meetings-archive')) {
          $(this).closest('.content').toggleClass(faqQuestionActiveClass);
          $(this).closest('.entity').toggleClass(faqQuestionActiveClass);
        }
        else {
          $(this).closest('.field-item').toggleClass(faqQuestionActiveClass);
        }
      })
